...
## Clock Signal
set_property -dict { PACKAGE_PIN R4    IOSTANDARD LVCMOS33 } [get_ports { clk_osc }]; #IO_L13P_T2_MRCC_34 Sch=sysclk
...
set_property PACKAGE_PIN W1 [get_ports {hdmi_p[0]}];
set_property PACKAGE_PIN Y1 [get_ports {hdmi_n[0]}];
set_property PACKAGE_PIN AA1 [get_ports {hdmi_p[1]}];
set_property PACKAGE_PIN AB1 [get_ports {hdmi_n[1]}];
set_property PACKAGE_PIN AB3 [get_ports {hdmi_p[2]}];
set_property PACKAGE_PIN AB2 [get_ports {hdmi_n[2]}];
set_property PACKAGE_PIN T1 [get_ports {hdmi_p[3]}];
set_property PACKAGE_PIN U1 [get_ports {hdmi_n[3]}];
...
set_property -dict {PACKAGE_PIN AB22 IOSTANDARD LVCMOS33} [get_ports oled_cs];
set_property -dict {PACKAGE_PIN AB21 IOSTANDARD LVCMOS33} [get_ports oled_mosi];
#set_property -dict { PACKAGE_PIN AB20    IOSTANDARD LVCMOS33 } [get_ports { }]; #IO_L13P_T2_MRCC_35 Sch=jd[3]
set_property -dict {PACKAGE_PIN AB18 IOSTANDARD LVCMOS33} [get_ports oled_sck];
set_property -dict {PACKAGE_PIN Y21 IOSTANDARD LVCMOS33} [get_ports oled_dc];
set_property -dict {PACKAGE_PIN AA21 IOSTANDARD LVCMOS33} [get_ports oled_rst];
set_property -dict {PACKAGE_PIN AA20 IOSTANDARD LVCMOS33} [get_ports oled_pmoden];
set_property PACKAGE_PIN AA18 [get_ports oled_vccen];
...
set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33 } [get_ports { gpio[0] }]; #IO_L18P_T2_34 Sch=jc_p[1]
set_property -dict { PACKAGE_PIN AA6   IOSTANDARD LVCMOS33 } [get_ports { gpio[1] }]; #IO_L18N_T2_34 Sch=jc_n[1]
set_property -dict { PACKAGE_PIN AA8   IOSTANDARD LVCMOS33 } [get_ports { gpio[2] }]; #IO_L22P_T3_34 Sch=jc_p[2]
set_property -dict { PACKAGE_PIN AB8   IOSTANDARD LVCMOS33 } [get_ports { gpio[3] }]; #IO_L22N_T3_34 Sch=jc_n[2]
set_property -dict { PACKAGE_PIN R6    IOSTANDARD LVCMOS33 } [get_ports { gpio[4] }]; #IO_L17P_T2_34 Sch=jc_p[3]
set_property -dict { PACKAGE_PIN T6    IOSTANDARD LVCMOS33 } [get_ports { gpio[5] }]; #IO_L17N_T2_34 Sch=jc_n[3]
set_property -dict { PACKAGE_PIN AB7   IOSTANDARD LVCMOS33 } [get_ports { gpio[6] }]; #IO_L20P_T3_34 Sch=jc_p[4]
set_property -dict { PACKAGE_PIN AB6   IOSTANDARD LVCMOS33 } [get_ports { gpio[7] }]; #IO_L20N_T3_34 Sch=jc_n[4]
...
#set_property -dict { PACKAGE_PIN J14   IOSTANDARD LVCMOS33 } [get_ports { gpio[0] }]; #IO_L3P_T0_DQS_AD1P_15 Sch=xa_p[1]
#set_property -dict { PACKAGE_PIN H14   IOSTANDARD LVCMOS33 } [get_ports { gpio[1] }]; #IO_L3N_T0_DQS_AD1N_15 Sch=xa_n[1]
#set_property -dict { PACKAGE_PIN H13   IOSTANDARD LVCMOS33 } [get_ports { gpio[2] }]; #IO_L1P_T0_AD0P_15 Sch=xa_p[2]
#set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { gpio[3] }]; #IO_L1N_T0_AD0N_15 Sch=xa_n[2]
#set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { gpio[4] }]; #IO_L2P_T0_AD8P_15 Sch=xa_p[3]
#set_property -dict { PACKAGE_PIN G16   IOSTANDARD LVCMOS33 } [get_ports { gpio[5] }]; #IO_L2N_T0_AD8N_15 Sch=xa_n[3]
#set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { gpio[6] }]; #IO_L5P_T0_AD9P_15 Sch=xa_p[4]
#set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { gpio[7] }]; #IO_L5N_T0_AD9N_15 Sch=xa_n[4]
...
set_property -dict {PACKAGE_PIN T19 IOSTANDARD LVCMOS33} [get_ports flash_csn];
