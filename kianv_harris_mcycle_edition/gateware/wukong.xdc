...
#set_property -dict {PACKAGE_PIN G5 IOSTANDARD LVCMOS33} [get_ports uart_tx]
#
#set_property -dict { PACKAGE_PIN H13   IOSTANDARD LVCMOS33 } [get_ports { flash_sclk }];
set_property -dict {PACKAGE_PIN P18 IOSTANDARD LVCMOS33} [get_ports flash_csn]
set_property -dict {PACKAGE_PIN R14 IOSTANDARD LVCMOS33} [get_ports flash_mosi]
set_property -dict {PACKAGE_PIN R15 IOSTANDARD LVCMOS33} [get_ports flash_miso]

set_property IOSTANDARD LVCMOS33 [get_ports clk_osc]

set_property IOSTANDARD TMDS_33 [get_ports {hdmi_n[3]}]
set_property PACKAGE_PIN D4 [get_ports {hdmi_p[3]}]
set_property PACKAGE_PIN C4 [get_ports {hdmi_n[3]}]
set_property IOSTANDARD TMDS_33 [get_ports {hdmi_p[3]}]

set_property PACKAGE_PIN D1 [get_ports hdmi_n[0]}]
set_property IOSTANDARD TMDS_33 [get_ports {hdmi_n[0]}]
set_property PACKAGE_PIN E1 [get_ports {hdmi_p[0]}]
set_property IOSTANDARD TMDS_33 [get_ports {hdmi_p[0]}]

set_property IOSTANDARD TMDS_33 [get_ports {hdmi_n[1]}]
set_property PACKAGE_PIN F2 [get_ports {hdmi_p[1]}]
set_property PACKAGE_PIN E2 [get_ports {hdmi_n[1]}]
set_property IOSTANDARD TMDS_33 [get_ports {hdmi_p[1]}]

set_property IOSTANDARD TMDS_33 [get_ports {hdmi_n[2]}]
set_property PACKAGE_PIN G2 [get_ports {hdmi_p[2]}]
set_property PACKAGE_PIN G1 [get_ports {hdmi_n[2]}]
...
set_property PACKAGE_PIN J6 [get_ports {led[1]}]
...
#set_property CLOCK_DEDICATED_ROU FALSE [get_nets clk_tmds_i/clk_in1_tmds_clk]

set_property PACKAGE_PIN M22 [get_ports clk_osc]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {clk_osc}]
