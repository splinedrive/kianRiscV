...
uint32_t framebuffer[HRES*VRES];
...
/* default 16 bit */
/*
void oled_show_fb(uint32_t *framebuffer, uint32_t *target_fb) {
  oled_show_fb_8or16(framebuffer, target_fb, 0);
}
*/
...
void fb_draw_bresenham(uint32_t *fb, int x0, int y0, int x1, int y1, short color)
{
