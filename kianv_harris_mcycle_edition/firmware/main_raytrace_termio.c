...
/* adapted from https://github.com/BrunoLevy/learn-fpga/blob/master/FemtoRV/FIRMWARE/LiteX/TinyRaytracer/tinyraytracer.c */
static void set_pixel(volatile Pixel *fb, int x, int y, float r, float g, float b) {
