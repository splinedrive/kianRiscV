...
main:
	...
	sw	s0,24(sp)	#,
	sw	s2,16(sp)	#,
# main_rv32m.c:8:       print_str("Multiplication and Division:");
	lui	s1,%hi(.LC1)	# tmp76,
# main_rv32m.c:6:     for (unsigned int i = 1; i < 1<<16; i++) {
	li	s3,65536		# tmp77,
.L80:
# main_rv32m.c:6:     for (unsigned int i = 1; i < 1<<16; i++) {
	li	s0,1		# i,
.L78:
# main_rv32m.c:7:       unsigned int square = i*i;
	mul	s2,s0,s0	# powmult_37, i, i
# main_rv32m.c:8:       print_str("Multiplication and Division:");
	addi	a0,s1,%lo(.LC1)	#, tmp76,
	call	print_str		#
# main_rv32m.c:9:       print_dec(i);
	mv	a0,s0	#, i
	call	print_dec		#
# main_rv32m.c:10:       print_chr('*');
	li	a0,42		#,
	call	putchar		#
# main_rv32m.c:11:       print_dec(i);
	mv	a0,s0	#, i
	call	print_dec		#
# main_rv32m.c:12:       print_chr('=');
	li	a0,61		#,
	call	putchar		#
# main_rv32m.c:13:       print_dec(square);
	mv	a0,s2	#, powmult_37
	call	print_dec		#
# main_rv32m.c:14:       print_chr('/');
	li	a0,47		#,
	call	putchar		#
# main_rv32m.c:15:       print_dec(i);
	mv	a0,s0	#, i
	call	print_dec		#
# main_rv32m.c:16:       print_chr('=');
	li	a0,61		#,
	call	putchar		#
# main_rv32m.c:17:       print_dec(square/i);
	mv	a0,s0	#, i
	call	print_dec		#
# main_rv32m.c:18:       print_chr(10);
	li	a0,10		#,
# main_rv32m.c:6:     for (unsigned int i = 1; i < 1<<16; i++) {
	addi	s0,s0,1	#, i, i
# main_rv32m.c:18:       print_chr(10);
	call	putchar		#
# main_rv32m.c:6:     for (unsigned int i = 1; i < 1<<16; i++) {
	bne	s0,s3,.L78	#, i, tmp77,
.L79:
# main_rv32m.c:22:       unsigned int square = i*i;
	mul	s2,s0,s0	# powmult_38, i, i
# main_rv32m.c:23:       print_str("Multiplication and Division:");
	addi	a0,s1,%lo(.LC1)	#, tmp76,
	call	print_str		#
# main_rv32m.c:24:       print_dec(i);
	mv	a0,s0	#, i
	call	print_dec		#
# main_rv32m.c:25:       print_chr('*');
	li	a0,42		#,
	call	putchar		#
# main_rv32m.c:26:       print_dec(i);
	mv	a0,s0	#, i
	call	print_dec		#
# main_rv32m.c:27:       print_chr('=');
	li	a0,61		#,
	call	putchar		#
# main_rv32m.c:28:       print_dec(square);
	mv	a0,s2	#, powmult_38
	call	print_dec		#
# main_rv32m.c:29:       print_chr('/');
	li	a0,47		#,
	call	putchar		#
# main_rv32m.c:30:       print_dec(i);
	mv	a0,s0	#, i
	call	print_dec		#
# main_rv32m.c:31:       print_chr('=');
	li	a0,61		#,
	call	putchar		#
# main_rv32m.c:32:       print_dec(square/i);
	divu	a0,s2,s0	# i,, powmult_38
# main_rv32m.c:21:     for (unsigned int i = 1<<16; i >= 1; i--) {
	addi	s0,s0,-1	#, i, i
# main_rv32m.c:32:       print_dec(square/i);
	call	print_dec		#
# main_rv32m.c:33:       print_chr(10);
	li	a0,10		#,
	call	putchar		#
# main_rv32m.c:21:     for (unsigned int i = 1<<16; i >= 1; i--) {
	bne	s0,zero,.L79	#, i,,
