...
## Pmod Header JB
#set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVCMOS33 } [get_ports { hdmi_p[0] }]; #IO_L11P_T1_SRCC_15 Sch=jb_p[1]
#set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { hdmi_n[0] }]; #IO_L11N_T1_SRCC_15 Sch=jb_n[1]
#set_property -dict { PACKAGE_PIN D15   IOSTANDARD LVCMOS33 } [get_ports { hdmi_p[1] }]; #IO_L12P_T1_MRCC_15 Sch=jb_p[2]
#set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { hdmi_n[1] }]; #IO_L12N_T1_MRCC_15 Sch=jb_n[2]
#set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS33 } [get_ports { hdmi_p[2] }]; #IO_L23P_T3_FOE_B_15 Sch=jb_p[3]
#set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { hdmi_n[2] }]; #IO_L23N_T3_FWE_B_15 Sch=jb_n[3]
#set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { hdmi_p[3] }]; #IO_L24P_T3_RS1_15 Sch=jb_p[4]
#set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { hdpi_n[3] }]; #IO_L24N_T3_RS0_15 Sch=jb_n[4]
...
#
## Pmod Header JD
#set_property -dict { PACKAGE_PIN D4   IOSTANDARD TMDS_33} [get_ports { hdmi_p[0] }]; #IO_L11N_T1_SRCC_35 Sch=jd[1]
#set_property -dict { PACKAGE_PIN D3   IOSTANDARD TMDS_33} [get_ports { hdmi_n[0] }]; #IO_L12N_T1_MRCC_35 Sch=jd[2]
#set_property -dict { PACKAGE_PIN F4   IOSTANDARD TMDS_33} [get_ports { hdmi_p[1] }]; #IO_L13P_T2_MRCC_35 Sch=jd[3]
#set_property -dict { PACKAGE_PIN F3   IOSTANDARD TMDS_33} [get_ports { hdmi_n[1] }]; #IO_L13N_T2_MRCC_35 Sch=jd[4]
#set_property -dict { PACKAGE_PIN E2   IOSTANDARD TMDS_33} [get_ports { hdmi_p[2] }]; #IO_L14P_T2_SRCC_35 Sch=jd[7]
#set_property -dict { PACKAGE_PIN D2   IOSTANDARD TMDS_33} [get_ports { hdmi_n[2] }]; #IO_L14N_T2_SRCC_35 Sch=jd[8]
#set_property -dict { PACKAGE_PIN H2   IOSTANDARD TMDS_33} [get_ports { hdmi_p[3] }]; #IO_L15P_T2_DQS_35 Sch=jd[9]
#set_property -dict { PACKAGE_PIN G2   IOSTANDARD TMDS_33} [get_ports { hdmi_n[3] }]; #IO_L15N_T2_DQS_35 Sch=jd[10]

##Pmod Header JB
#set_property -dict { PACKAGE_PIN E15   IOSTANDARD TMDS_33 } [get_ports { hdmi_p[0] }]; #IO_L11P_T1_SRCC_15 Sch=jb_p[1]
#set_property -dict { PACKAGE_PIN E16   IOSTANDARD TMDS_33 } [get_ports { hdmi_n[0] }]; #IO_L11N_T1_SRCC_15 Sch=jb_n[1]
#set_property -dict { PACKAGE_PIN D15   IOSTANDARD TMDS_33 } [get_ports { hdmi_p[1] }]; #IO_L12P_T1_MRCC_15 Sch=jb_p[2]
#set_property -dict { PACKAGE_PIN C15   IOSTANDARD TMDS_33 } [get_ports { hdmi_n[1] }]; #IO_L12N_T1_MRCC_15 Sch=jb_n[2]
#set_property -dict { PACKAGE_PIN J17   IOSTANDARD TMDS_33 } [get_ports { hdmi_p[2] }]; #IO_L23P_T3_FOE_B_15 Sch=jb_p[3]
#set_property -dict { PACKAGE_PIN J18   IOSTANDARD TMDS_33 } [get_ports { hdmi_n[2] }]; #IO_L23N_T3_FWE_B_15 Sch=jb_n[3]
#set_property -dict { PACKAGE_PIN K15   IOSTANDARD TMDS_33 } [get_ports { hdmi_p[3] }]; #IO_L24P_T3_RS1_15 Sch=jb_p[4]
#set_property -dict { PACKAGE_PIN J15   IOSTANDARD TMDS_33 } [get_ports { hdmi_n[3] }]; #IO_L24N_T3_RS0_15 Sch=jb_n[4]
#
set_property PACKAGE_PIN E3 [get_ports clk_osc]
set_property IOSTANDARD LVCMOS33 [get_ports clk_osc]
create_clock -period 10.000 -name sys_clk_pin -waveform {0.000 5.000} -add [get_ports clk_osc]


set_property -dict {PACKAGE_PIN D10 IOSTANDARD LVCMOS33} [get_ports uart_tx]

set_property -dict {PACKAGE_PIN L13 IOSTANDARD LVCMOS33} [get_ports flash_csn]
...
## Pmod Header JD
set_property -dict {PACKAGE_PIN D4 IOSTANDARD LVCMOS33} [get_ports oled_cs]
set_property -dict {PACKAGE_PIN D3 IOSTANDARD LVCMOS33} [get_ports oled_mosi]
#set_property -dict { PACKAGE_PIN F4    IOSTANDARD LVCMOS33 } [get_ports { }]; #IO_L13P_T2_MRCC_35 Sch=jd[3]
set_property -dict {PACKAGE_PIN F3 IOSTANDARD LVCMOS33} [get_ports oled_sck]
set_property -dict {PACKAGE_PIN E2 IOSTANDARD LVCMOS33} [get_ports oled_dc]
set_property -dict {PACKAGE_PIN D2 IOSTANDARD LVCMOS33} [get_ports oled_rst]
set_property -dict {PACKAGE_PIN G2 IOSTANDARD LVCMOS33} [get_ports oled_pmoden]
set_property PACKAGE_PIN H2 [get_ports oled_vccen]
...
## Pmod Header JB
set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVCMOS33 } [get_ports { gpio[0] }]; #IO_L11P_T1_SRCC_15 Sch=jb_p[1]
set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { gpio[1] }]; #IO_L11N_T1_SRCC_15 Sch=jb_n[1]
set_property -dict { PACKAGE_PIN D15   IOSTANDARD LVCMOS33 } [get_ports { gpio[2] }]; #IO_L12P_T1_MRCC_15 Sch=jb_p[2]
set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { gpio[3] }]; #IO_L12N_T1_MRCC_15 Sch=jb_n[2]
set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS33 } [get_ports { gpio[4] }]; #IO_L23P_T3_FOE_B_15 Sch=jb_p[3]
set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { gpio[5] }]; #IO_L23N_T3_FWE_B_15 Sch=jb_n[3]
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { gpio[6] }]; #IO_L24P_T3_RS1_15 Sch=jb_p[4]
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { gpio[7] }]; #IO_L24N_T3_RS0_15 Sch=jb_n[4]

## Pmod Header JC
set_property PACKAGE_PIN V10 [get_ports {hdmi_p[0]}]
set_property PACKAGE_PIN V11 [get_ports {hdmi_n[0]}]
set_property PACKAGE_PIN U14 [get_ports {hdmi_p[1]}]
set_property PACKAGE_PIN V14 [get_ports {hdmi_n[1]}]
set_property PACKAGE_PIN U12 [get_ports {hdmi_p[2]}]
set_property PACKAGE_PIN V12 [get_ports {hdmi_n[2]}]
set_property PACKAGE_PIN T13 [get_ports {hdmi_p[3]}]
set_property PACKAGE_PIN U13 [get_ports {hdmi_n[3]}]
