...
## Pmod Header JC
#set_property -dict { PACKAGE_PIN GJ2    IOSTANDARD LVCMOS33 } [get_ports { }]; #IO_L13P_T2_MRCC_35 Sch=jd[3]

## PMOD Head JC
#set_property -dict { PACKAGE_PIN J2   IOSTANDARD LVCMOS33 } [get_ports { JA[3] }]; #IO_L21P_T3_DQS_15 Sch=ja[3]

## Pmod Header JB
set_property -dict {PACKAGE_PIN D14 IOSTANDARD LVCMOS33} [get_ports {gpio[0]}]
set_property -dict {PACKAGE_PIN F16 IOSTANDARD LVCMOS33} [get_ports {gpio[1]}]
set_property -dict {PACKAGE_PIN G16 IOSTANDARD LVCMOS33} [get_ports {gpio[2]}]
set_property -dict {PACKAGE_PIN H14 IOSTANDARD LVCMOS33} [get_ports {gpio[3]}]
set_property -dict {PACKAGE_PIN E16 IOSTANDARD LVCMOS33} [get_ports {gpio[4]}]
set_property -dict {PACKAGE_PIN F13 IOSTANDARD LVCMOS33} [get_ports {gpio[5]}]
set_property -dict {PACKAGE_PIN G13 IOSTANDARD LVCMOS33} [get_ports {gpio[6]}]
set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS33} [get_ports {gpio[7]}]
...
set_property PACKAGE_PIN D18 [get_ports {hdmi_n[2]}]
set_property PACKAGE_PIN E17 [get_ports {hdmi_n[1]}]
set_property PACKAGE_PIN G17 [get_ports {hdmi_n[0]}]
set_property PACKAGE_PIN G18 [get_ports {hdmi_n[3]}]
set_property PACKAGE_PIN F18 [get_ports {hdmi_p[3]}]
set_property PACKAGE_PIN C17 [get_ports {hdmi_p[2]}]
set_property PACKAGE_PIN D17 [get_ports {hdmi_p[1]}]
set_property PACKAGE_PIN E18 [get_ports {hdmi_p[0]}]
